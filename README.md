# Harrisonville Church of Christ Website
...
## Member portal (this build)

The `/members` area is a full member app for the congregation, built on the
site's own tokens and primitives:

- **Home** — announcements, a getting-started checklist, what is coming up,
  who is serving at the next assemblies, and communion status.
- **Directory** — by family or by person, with member, family, and child
  pages and this week's birthdays and anniversaries.
- **Chat** — Congregation, Men, and Ladies chats, admin-made groups, and
...
- **Communion preparation** — sign a household up for a month; reminders a
  week and a day before.
- **Service schedule** — entered by hand each month by an editor; shown on
...
This repository is built for the Harrisonville Church of Christ website. The Harrisonville Church of Christ is based in Harrisonville, MO, and meets at 1203 Outlook Drive, Harrisonville, MO 64701. The have Scripture-based worship and open Bible study. No creed but the Bible.
