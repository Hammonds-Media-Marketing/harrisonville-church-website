import type { Author, BlogPost, BlogCategory } from './types'

/** SAMPLE author. Real author identity (name, role, bio, photo, LinkedIn) is
 *  required for E-E-A-T and will replace this placeholder before launch. */
export const authors: Author[] = [
  {
    slug: 'sample-author',
    name: 'Sample Author',
    role: 'Evangelist, Harrisonville Church of Christ',
    bio: 'Placeholder author bio. The real author teaches and writes for the congregation from the New Testament.',
    longBio:
    ...
    photoAlt: 'Placeholder portrait — author photo to be supplied',
    linkedin: '',
    sample: true,
  },
]
...
/** SAMPLE posts. Each carries genuine topical depth so the layout, table of
 *  contents, read-time, and related-articles features render realistically.
 *  Replace with real articles before launch. */
export const posts: BlogPost[] = [
  {
    slug: 'what-does-the-bible-say-about-baptism',
    title: 'What Does the Bible Say About Baptism?',
    excerpt:
    ...
    ogTitle: 'Baptism in the New Testament, Explained Plainly',
    ogDescription:
      'Read the passages on baptism in context and weigh them yourself, without denominational assumptions added on top.',
    category: 'Salvation',
    tags: ['baptism', 'salvation', 'book of Acts', 'new testament'],
    authorSlug: 'sample-author',
    datePublished: '2026-05-20',
    dateModified: '2026-06-02',
    featureImage: '/assets/images/placeholder.jpg',
    featureImageAlt: 'Placeholder feature image — open Bible, to be replaced',
    readMinutes: 7,
    views: 1284,
    body: [
    ...
    relatedSlugs: ['why-no-instruments-in-worship', 'how-do-i-know-which-church-is-right'],
    sample: true,
  },
  {
    slug: 'why-no-instruments-in-worship',
    title: 'Why Do Churches of Christ Sing Without Instruments?',
    excerpt:
    ...
    ogTitle: 'The Reason Behind A Cappella Worship',
    ogDescription:
    ...
    category: 'Worship',
    tags: ['worship', 'singing', 'a cappella', 'authority'],
    authorSlug: 'sample-author',
    datePublished: '2026-05-06',
    featureImage: '/assets/images/placeholder.jpg',
    featureImageAlt: 'Placeholder feature image — hymnal, to be replaced',
    readMinutes: 5,
    views: 962,
    body: [
    ...
    relatedSlugs: ['what-does-the-bible-say-about-baptism', 'how-do-i-know-which-church-is-right'],
    sample: true,
  },
  {
    slug: 'how-do-i-know-which-church-is-right',
    title: 'How Do I Know Which Church Is Right?',
    excerpt:
    ...
    ogTitle: 'Choosing a Church Without the Confusion',
    ogDescription:
      'A calm, practical way to cut through denominational noise: test what you are taught against Scripture itself.',
    category: 'The Church',
    tags: ['denominations', 'authority', 'bible study', 'first-century church'],
    authorSlug: 'sample-author',
    datePublished: '2026-04-18',
    featureImage: '/assets/images/placeholder.jpg',
    featureImageAlt: 'Placeholder feature image — country church, to be replaced',
    readMinutes: 6,
    views: 1530,
    body: [
    ...
    relatedSlugs: ['what-does-the-bible-say-about-baptism', 'why-no-instruments-in-worship'],
    sample: true,
  },
]
...
export function postsByAuthor(slug: string): BlogPost[] {
  return posts.filter((p) => p.authorSlug === slug)
}

export function recentPosts(): BlogPost[] {
